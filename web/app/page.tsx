...
/* Community links land when the channels open; icons sit unlinked until then. */
const socials = [
    ...
    <div className="flex min-h-full flex-col">
      ...
      <footer className="border-t border-line">
        <div className="mx-auto flex max-w-[1280px] flex-wrap items-center justify-between gap-5 px-4 py-8 sm:px-6">
          ...
          <div className="mono flex items-center gap-5 text-[10px] uppercase tracking-[.1em] text-dim">
            ...
            {socials.map(([name, d]) => (
              <span key={name} role="img" aria-label={`${name} (coming soon)`} title={`${name} · soon`} className="transition-colors hover:text-fg">
